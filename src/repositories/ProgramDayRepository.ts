...
export const ProgramDayRepository = {
     ...
     */
    create: async (data: Omit<ProgramDay, 'id' | 'orderIndex' | 'isRestDay' | 'previousName'> & { orderIndex?: number, isRestDay?: boolean, previousName?: string | null }): Promise<ProgramDay> => {
